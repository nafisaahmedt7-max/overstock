...
const pages: Record<string, { title: string; copy: string[] }> = {
  terms: { title: "TERMS", copy: ["By using OVERSTOCK you agree to provide accurate order information and use the service lawfully.", "Products are supplied by OVERSTOCK or independent sellers. Availability may change before an order is confirmed.", "These terms do not limit rights that cannot be excluded under applicable law."] },
  ...
  refunds: { title: "REFUND POLICY", copy: ["All purchases are final sale because products are low-cost and may be supplied by independent sellers.", "We do not offer change-of-mind returns or refunds. Nothing on this page excludes remedies required by applicable law."] },
